...
func (tx *Tx) init() {
	tx.Lunch = NewLunchClient(tx.config)
	tx.LunchParticipant = NewLunchParticipantClient(tx.config)
}
...
// applies a query, for example: Lunch.QueryXXX(), the query will be executed
